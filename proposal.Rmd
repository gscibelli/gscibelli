...
1. All Trails Data
  - This data is from the Alltrails website, which is a platform containing all hiking trails, and important decriptions. 
  - variables: 
    - trail_id
    - name
    - area_name
...
```{r}
knitr::include_graphics('img/SummaryAllTrails.png')
```
